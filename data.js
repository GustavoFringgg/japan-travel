...
const trip = {
    flights: {
        out: {
            ...
            from: "TPE", fromName: "台灣桃園",
            to:   "KIX", toName:   "關西國際",
            depart: "09:00", arrive: "12:35",
            date: "2026/10/01"
        },
        ret: {
            flightNo: "MM 928",
            airline: "Peach Aviation",
            from: "KIX", fromName: "關西國際",
            to:   "TPE", toName:   "台灣桃園",
            depart: "18:00", arrive: "19:45",
            date: "2026/10/06"
        }
    },
    hotels: [
        {
            name: "Dormy Inn Premium 難波",
            area: "難波・中央區",
            nights: "10/1 – 10/3",
            checkIn: "15:00",
            checkOut: "11:00"
    ...
    days: [
        ...
        },
        {
            ...
            items: [
                ...
                { time: "16:00", icon: "🏙️", name: "あべのハルカス", note: "日本最高百貨 · 58F 展望台 ¥2,000 · 日落前入場最值" },
                { time: "19:00", icon: "🍺", name: "晚餐：居酒屋", note: "天王寺附近找下班族聚集的熱鬧小店" }
            ]
        },
        {
            date: "10/4", wd: "Sun",
            title: "梅田・北大阪", tag: "Day 4",
            items: [
        ...
        {
            date: "10/5", wd: "Mon",
            title: "Universal Studios Japan", tag: "Day 5",
            items: [
                ...
                { time: "19:00", icon: "🌙", name: "夜間遊行 & 煙火", note: "10月特殊活動季，確認當天 night show 節目表", hi: true },
                { time: "21:00", icon: "🍜", name: "離園，宵夜", note: "難波或環球城周邊找宵夜補充體力" }
            ]
        },
        {
            date: "10/6", wd: "Tue",
            title: "最後の大阪・回家", tag: "Day 6",
            items: [
                ...
                { time: "15:00", icon: "🚄", name: "前往關西機場", note: "南海電鐵 Rapi:t 特急 · 難波出發 · 約45分 · 請提早！" },
...
const savedPlaces = [
    ...
    { name: "串カツ 達磨 新世界",    cat: "美食", note: "新世界元祖名店・二度漬け禁止！",            mapQuery: "串カツ達磨 新世界 大阪" },
    { name: "一蘭拉麵 道頓堀店",     cat: "美食", note: "隔板單人座位，豚骨湯底經典款",              mapQuery: "一蘭 道頓堀 大阪" },
    // 玩樂
    { name: "Universal Studios Japan", cat: "玩樂", note: "哈利波特・Minion Park・10月夜間遊行", mapQuery: "Universal Studios Japan Osaka" },
    { name: "HEP FIVE 摩天輪",       cat: "玩樂", note: "梅田地標・¥600・俯瞰大阪市景",             mapQuery: "HEP FIVE 大阪 梅田" },
    { name: "あべのハルカス",         cat: "玩樂", note: "日本最高百貨58F展望台・¥2,000・日落前最值", mapQuery: "あべのハルカス 大阪" },
    // 景點
